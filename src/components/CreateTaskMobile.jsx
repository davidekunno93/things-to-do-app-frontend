...
const CreateTaskMobile = ({ open, tasks, category, setTasks, onClose }) => {
    ...
    const [hourPicked, setHourPicked] = useState(newTask.endTime ? newTask.endTime.slice(0, 2) : null);
    const pickHour = (hour) => {
    ...
    // set to task time if exists
    const [minutePicked, setMinutePicked] = useState(newTask.endTime ? newTask.endTime.slice(3, 5) : null);
